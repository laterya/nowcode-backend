...
import com.yp.nowapisdk.model.request.CurrencyRequest;
...
import com.yp.nowcode.model.dto.interfaceinfo.*;
import com.yp.nowcode.model.entity.User;
import com.yp.nowcode.model.enums.InterfaceStatusEnum;
...
import com.yp.nowcodecommon.common.IdRequest;
...
import static com.yp.nowcode.constant.UserConstant.ADMIN_ROLE;
...
public class InterfaceInfoController {
    ...
    public BaseResponse<Object> invokeInterface(@RequestBody InvokeRequest invokeRequest, HttpServletRequest request) {
        ...
        try {
            NowApiClient nowApiClient = new NowApiClient(accessKey, secretKey);
            ...
            ResultResponse response = apiService.request(nowApiClient, currencyRequest);
